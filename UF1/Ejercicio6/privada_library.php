<?php
	...
	//Botón de hacer logout y de editar productos
	echo "<form class=\"form-horizontal\" enctype=\"multipart/form-data\" action=\"privada.php\" method=\"post\" id=\"aute\" name=\"logout\">";
		...
		echo "<div style=\"float:right\">";
			echo "<button style=\"width:120px\"id=\"mysubmit\" type=\"submit\" name=\"products\">Mis Productos</button><br>";
		echo "</div><br>";
	echo"</form>";
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if(isset($_REQUEST["products"])){
			...
			//Ve hacia la pagina de productos
